       ...
       <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Добавить книгу из Ютуба <?php echo $_GET['add'];?></h4>
                            </div>
                            <div class="content">
                                <form action="add-youtube.php?add=<?php echo $_GET['add'];?>" method="post">
                                     <div class="row">
                                        <div class="col-md-5">
...
$$link = $_POST['link'];
$id_knigi = $id; // создаем свой id книги
$query = "INSERT INTO `link` (id_knigi, links, stoping) VALUES ('$id_knigi', '$link', '01')"; // Создаем переменную с запросом к базе данных на отправку нового 
...
$("#send").click(function(){
 ...
 $("#status").load("ajax-youtube-two.php","link="+$("#link").val()); /* Так мы собираем данные из форм и сразу отправляем! */
