 ...
 <div class="row">
                                        <div class="col-md-5">
											...
											$arr_audio = array();
												...
												// // echo '<audio controls>
												// 	// <source src="'.$arr.'mp3" type="audio/mp3">
												// 	// </audio>';
												// 	// echo '<audio controls>';
												// 	// echo '<source src="'.$arr.'" type="audio/mp3">';
												// 	// echo '</audio>';
												// }
...
foreach ($link as $val) {
   ...
   // print_r($vid);
    $arr_audio[] = $vid['0'];
   echo '<iframe width="560" height="315" src="https://www.youtube.com/embed/'.$vid[0].'" frameborder="0" allowfullscreen></iframe> </br>';
}

											//	echo $arr_audio[1];
											// echo '<iframe width="560" height="315" src="https://www.youtube.com/embed/'.$arr_audio[1].'" frameborder="0" allowfullscreen></iframe>';
														 $ar = serialize($arr_audio);
?>
<textarea  style="display:block;" class="form-control" name="linksaudio" ><?php echo $ar;?></textarea>
                                            </div>
                                        </div>
                                    </div>
