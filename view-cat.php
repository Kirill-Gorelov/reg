...
$query = mysqli_query($connection, "SELECT `nazvanie`, `autor`, `id_knigi` FROM `kniga` WHERE `user_id` = '$login' AND `id_cat` = '$id_cat'"); 
...
// echo "<td height=\"45\"><a style=\"font-size:20px;\" href=/reg/play.php?id=".$result['id']." title=".$result['name'].">".$result['name']."</a></td>";
