       ...
       <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Добавить книгу из своего списка ссылок</h4>
                            </div>
                            <div class="content">
									 ...
									 <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control" name="link" id="link" placeholder="Вставьте id записи" required></textarea>
...
$query = "INSERT INTO `kniga` (id_knigi,nazvanie, autor, izdatelstvo, descriptionkniga, user_id, date, istochnik, oblozka) VALUES ('$id_knigi', '$nazvanie', '$autor', '$izdatelstvo', '$descriptionkniga', '$authorid', '$today', 'mylink', '$oblozka')"; // Создаем переменную с запросом к базе данных на отправку нового юзера
...
//echo $val;
$file = basename($val, ".mp3"); 
// echo $file;
$query = "INSERT INTO `link` (id_knigi, links, title_links, stoping) VALUES ('$id_knigi', '$val', '$file', '01')"; // Создаем переменную с запросом к базе данных на отправку нового юзера
...
$("#send").click(function(){
 ...
 $("#status").load("ajax-mylink.php","link="+$("#link").val()); /* Так мы собираем данные из форм и сразу отправляем! */
